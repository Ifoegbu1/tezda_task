...
class CustomContainedTabBarView extends StatefulWidget {
  const CustomContainedTabBarView({
    super.key,
    required this.tabs,
  ...
  @override
  State<StatefulWidget> createState() => CustomContainedTabBarViewState();
}

class CustomContainedTabBarViewState extends State<CustomContainedTabBarView>
